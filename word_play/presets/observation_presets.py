...
# TODO: DELETE, THIS IS FOR THE SIMULATANIOUS CONVERSATION ENV
def format_conversation_history(conversation_history: list[list[str]], all_agent_names: list[str], observing_agent_id: int) -> str:
...
def format_actions_taken(
		actions_taken: list[Action_Selection],
		all_agent_names: list[str],
		observing_agent_id: int
	) -> str:
	obs_str = ''
