...
from benchmarks.text_mp.substrates.coop_mining.builder import build_env  # noqa: E402
from benchmarks.text_mp.substrates.coop_mining.variants import VARIANTS  # noqa: E402


def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run a Coop Mining Text Melting Pot example.")
...
def main(argv: list[str] | None = None) -> None:
    ...
    print(f"Text Melting Pot: coop_mining:{variant.name}")
    print(f"Policy: {args.policy}")
    run_episode(
        env,
        max_steps=args.max_steps,
        event_attributes=("coop_mining_events",),
