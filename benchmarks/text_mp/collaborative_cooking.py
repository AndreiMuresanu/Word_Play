...
from benchmarks.text_mp.substrates.collaborative_cooking.builder import build_env  # noqa: E402
from benchmarks.text_mp.substrates.collaborative_cooking.variants import VARIANTS  # noqa: E402


def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run a Collaborative Cooking Text Melting Pot example.")
...
def main(argv: list[str] | None = None) -> None:
    ...
    print(f"Text Melting Pot: collaborative_cooking:{variant.name}")
    print(f"Policy: {args.policy}")
    run_episode(
        env,
        max_steps=args.max_steps,
        event_attributes=("collaborative_cooking_events",),
