...
from benchmarks.text_mp.substrates.coop_mining.mechanics import (
    MINE_COOLDOWN,
    Mine_Gold_Ore,
    Mine_Iron_Ore,
    OreNode,
)
from benchmarks.text_mp.substrates.coop_mining.variants import CoopMiningVariant


def build_env(
    *,
    variant: CoopMiningVariant,
...
def _build_agent(
    ...
    agent_policy = make_policy(
        ...
        system_prompt=f"You are Player {agent_id} in Coop Mining. {variant.prompt}",
