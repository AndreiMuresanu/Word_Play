...
from benchmarks.text_mp.substrates.hidden_agenda.builder import build_env  # noqa: E402
from benchmarks.text_mp.substrates.hidden_agenda.variants import VARIANTS  # noqa: E402


def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run a Hidden Agenda Text Melting Pot example.")
...
def main(argv: list[str] | None = None) -> None:
    ...
    print(f"Text Melting Pot: hidden_agenda:{variant.name}")
    print(f"Policy: {args.policy}")
    run_episode(
        env,
        max_steps=args.max_steps,
        event_attributes=("hidden_agenda_events",),
