...
from benchmarks.text_mp.substrates.gift_refinements.builder import build_env  # noqa: E402
from benchmarks.text_mp.substrates.gift_refinements.variants import VARIANTS  # noqa: E402


def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run a Gift Refinements Text Melting Pot example.")
...
def main(argv: list[str] | None = None) -> None:
    ...
    print(f"Text Melting Pot: gift_refinements:{variant.name}")
    print(f"Policy: {args.policy}")
    run_episode(
        env,
        max_steps=args.max_steps,
        event_attributes=("gift_refinements_events",),
